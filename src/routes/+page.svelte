<script lang="ts">
  ...
  // Hover/open state for controls bar (SSOT)
  ...
  function toggleEditMode() {
    ...
    // Collapse menus when toggling edit mode
    if (!isEditMode) {
      ...
      {#if boundSessions.length > 0 || isEditMode}
        <div class="mixer-container" id="main-content">
          ...
          <div 
            ...
            onmouseleave={() => { 
              // If a menu is expanded, keep dock open. Otherwise close it.
          ...
          >
            ...
            >
              ...
              >
                  ...
                  <div class="add-app-list">
                    <div class="settings-container">
                      ...
                      <button
                        ...
                        onclick={async (e) => {
                          e.preventDefault();
                          await toggleWindowPinned();
                        }}
                        aria-label={windowPinned ? "Disable pin on top" : "Enable pin on top"}
                ...
                <button 
                  ...
                  onclick={() => {
                    ...
                    if (settingsMenuExpanded) closeMenuExpanded = false;
                  }}
                  onkeydown={(e) => {
                    if (e.key === 'Tab' && !e.shiftKey && !settingsMenuExpanded) {
                      e.preventDefault();
                      settingsMenuExpanded = true;
                      closeMenuExpanded = false;
                      setTimeout(() => {
                        const menu = document.querySelector('.settings-menu .add-app-list');
                  ...
                  aria-label={settingsMenuExpanded ? "Close settings menu" : "Open settings menu"}
              ...
              <div class="btn-add-app-container controls" class:hidden={settingsMenuExpanded || closeMenuExpanded}>
                <button 
              ...
              >
                {#if closeMenuExpanded}
                  <div class="add-app-list">
                    <button 
                      class="btn-close btn btn-add-app menu-option"
                      onclick={async () => { await invoke('quit_application'); }}
                    >
                      Quit
                    </button>
                    <button 
                      class="btn btn-add-app menu-option"
                ...
                <button 
                  ...
                  onclick={() => {
                    ...
                    if (closeMenuExpanded) settingsMenuExpanded = false;
                  }}
                  onkeydown={(e) => {
...
<style>
  ...
  * {
  ...
  /* Settings menu uses a shorter expanded height */
